const Footer = () => {
  return (
    <footer className="w-full bg-white border-t border-holidaze-border pt-[60px] px-6 pb-6 mt-10">
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-[60px] mb-10">
          <div className="flex flex-col gap-4">
            <h3 className="text-2xl font-semibold text-holidaze-gray m-0 tracking-tight">
              Holidaze
            </h3>
            <p className="text-[15px] text-holidaze-light-gray leading-relaxed m-0 max-w-[300px]">
